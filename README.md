...
This is a 2-player multiplayer race, which is how I presented it to my class, it was one of the best presentations that I'm the most proud of. If you'd like to play without Calculus level questions. Use the room code, "s3cr3t", it'll skip the question spawning loop. 
